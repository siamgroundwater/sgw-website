...
const navItems: NavItem[] = [
  ...
  { href: '/cms/teams', icon: UsersRound, label: { th: 'ทีมงาน', en: 'Teams' }, permission: 'teams:view' },
  { href: '/cms/media', icon: Images, label: { th: 'รูปภาพเว็บไซต์', en: 'Website images' }, permission: 'media:view' },
