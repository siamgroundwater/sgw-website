...
const chineseArticles: Record<LearningSlug, LocalizedArticle> = {
  ...
  'groundwater-law-regulation-thailand': {
    ...
    sources: officialSources.map((source) => ({
      ...source,
      label: source.label
        .replace('Department of Groundwater Resources — laws and regulations', '泰国地下水资源厅——法律与法规')
        .replace('Department of Groundwater Resources — public services', '泰国地下水资源厅——公共服务'),
    })),
  },
  'groundwater-faq-thailand': {
    slug: 'groundwater-faq-thailand',
...
const japaneseArticles: Record<LearningSlug, LocalizedArticle> = {
  ...
  'groundwater-law-regulation-thailand': {
    ...
    sources: officialSources.map((source) => ({
      ...source,
      label: source.label
        .replace('Department of Groundwater Resources — laws and regulations', 'タイ地下水資源局 — 法令・規則')
        .replace('Department of Groundwater Resources — public services', 'タイ地下水資源局 — 公共サービス'),
    })),
  },
  'groundwater-faq-thailand': {
    slug: 'groundwater-faq-thailand',
...
export const localizedContent: Record<LocalizedLocale, LocalizedContent> = {
  ...
  en: {
    ...
    home: {
      eyebrow: 'GROUNDWATER CONSERVATION',
      title: 'Drill quality wells. Install quality pumps. Use groundwater correctly.',
      summary: 'We aim to lead in drilling quality groundwater wells and developing groundwater for use according to sound technical principles.',
      assurance: 'We prevent aquifer damage and environmental harm, and care for every project so it has good-quality water that can be used sustainably and delivers value for the investment.',
      motto: 'Do good to give back to the land',
    ...
    about: {
      ...
      title: 'About us',
      intro: 'Siam Groundwater Co., Ltd. was founded in 1987 by groundwater specialists who had worked in the public sector. The company specializes in drilling, exploration, maintenance and groundwater use.',
      storyTitle: 'Our history',
      story: [
        'The company was established to drill and develop groundwater for use according to sound technical principles, encourage groundwater conservation, protect groundwater resources for sustainable use and make efficient use of those resources for the benefit of groundwater users and people throughout Thailand.',
        'Drawing on our experience and past work, we have continuously improved quality and efficiency by applying modern technology and knowledge. Today we provide groundwater studies, drill quality groundwater wells and develop water-management solutions suited to actual aquifer conditions and real operating needs.',
      ],
      ...
      teamTitle: 'The Siam Groundwater team',
      teamIntro: 'Our experienced survey team uses resistivity meters to investigate and interpret subsurface conditions. Our drilling team is trained and licensed by the Department of Groundwater Resources, while our maintenance team specializes in wells, pumps and pumping tests.',
    },
    services: {
      ...
      items: {
        survey: { title: 'Groundwater, mineral water, hot spring and EIA studies', short: 'Studies carried out by specialists and a highly skilled, experienced survey team.', intro: 'We conduct groundwater studies for projects planning to drill and use groundwater, using electrical resistivity surveys. Our work also covers mineral-water and hot-spring exploration and surveys for environmental impact assessment (EIA) reports.', highlights: ['Desktop review and site reconnaissance', 'Hydrogeological and geophysical investigation', 'Candidate drilling-point assessment', 'Study reporting for project and EIA coordination'], process: ['Define water demand and decision criteria', 'Review existing records and site risks', 'Complete field investigation', 'Rank drilling targets and next steps'] },
        drilling: { title: 'Groundwater, mineral water, hot spring and dewatering wells', short: 'Technically correct well drilling and pump installation, plus proper sealing of abandoned groundwater wells.', intro: 'We construct groundwater wells to accepted technical standards and in accordance with the Groundwater Act, including wells in sand-and-gravel aquifers, hard-rock wells, dewatering wells and observation wells.', highlights: ['Groundwater and production wells', 'Mineral-water and hot-spring wells', 'Dewatering and drawdown systems', 'Well development, pumping tests and handover records'], process: ['Confirm investigation findings and access', 'Set construction and acceptance criteria', 'Drill, log and construct the well', 'Develop, test and document performance'] },
        maintenance: { title: 'Groundwater well and pump maintenance', short: 'Correct maintenance helps groundwater wells and pumps provide a long service life.', intro: 'Long-serving wells may become clogged by sand, iron deposits or scale, reducing inflow. Wells should be air-cleaned and redeveloped, and pumps inspected every year or at an interval suited to actual operating conditions.', highlights: ['Air-development and well cleaning', 'Pump removal, inspection and repair', 'Pump setting and control adjustment', 'Flow, water-level and energy trend review'], process: ['Collect baseline and operating symptoms', 'Inspect the well and pumping system', 'Select the least-destructive effective treatment', 'Retest and set monitoring thresholds'] },
        consult: { title: 'Repairing damaged or problematic groundwater projects', short: 'Repairing a large well can be more cost-effective than drilling a new one.', intro: 'We use specialist repair methods for damaged 8–12 inch wells affected by sand, turbidity, blockage, saline-water intrusion, casing leaks, contaminated-water intrusion or pump failure. Repair can be faster and less expensive than drilling a replacement well, preserving the value of the original investment.', highlights: ['Low-yield and drawdown investigation', 'Sand, turbidity and well-integrity diagnosis', 'Salinity, acidity and contamination pathway review', 'Recovery plan and owner-side technical advice'], process: ['Review original records and failure history', 'Measure current hydraulic and water-quality conditions', 'Test the most likely causes', 'Prioritize repair, replacement or operating changes'] },
      },
    },
    projects: {
      eyebrow: 'PROJECT REGISTRY', title: 'Examples of our projects', intro: 'Our experience covers groundwater studies, quality groundwater-well drilling and groundwater-management planning suited to aquifer conditions, helping projects secure an adequate, sustainable supply of good-quality water.', all: 'All projects', showing: 'Showing', loadMore: 'Show more projects', details: 'View project', typeLabel: 'Project type', categoryLabel: 'Sector', location: 'Project location', yearLabel: 'Project year', workScopeLabel: 'Scope of work', businessTypeLabel: 'Business sector', projectStoryTitle: 'Work details', recoveredRecordNote: 'Adapted from the project registry and content published on the company’s former website.', registryNoteTitle: 'About this record', registryNote: 'This record is compiled from project information previously published on the company’s former website. Contractual details and sensitive client information remain private; contact our team for a comparable case study.', mapCta: 'Open location in Google Maps', enquiryCta: 'Ask about similar experience',
    ...
    governance: {
      eyebrow: 'GROUNDWATER CONSERVATION PROJECT', title: 'Use groundwater wisely so the nation’s water sources are not damaged', intro: 'Groundwater is valuable and should be developed with conservation in mind. The Groundwater Conservation Project was established on 22 December 2000 to promote wise use and protect groundwater sources for sustainable use.',
      pillars: [
      ...
      commitmentTitle: 'Groundwater conservation commitment', commitment: '“Use groundwater wisely so the nation’s water sources are not damaged. Groundwater is valuable and should be developed with conservation in mind.”',
    },
    learning: {
  ...
  zh: {
    ...
    home: { eyebrow: '地下水保护', title: '打造优质水井，安装优质水泵，正确抽取和使用地下水', summary: '我们致力于成为优质地下水井施工的领先者，并依照专业技术原则开发利用地下水。', assurance: '防止含水层受损，不破坏环境，并持续维护每个项目，使其长期获得优质用水并实现合理的投资价值。', motto: '以善行回馈大地', primaryCta: '咨询您的项目', secondaryCta: '查看我们的服务', servicesTitle: '同一支技术团队，负责水井的完整使用周期', servicesIntro: '从勘查、钻井、安装水泵、水质检测到长期维护的协调，可减少设计衔接上的缺口。', projectsTitle: '项目遍布全国各地区', projectsIntro: '涵盖泰国及周边地区的政府、工业、酒店、农业与基础设施项目。', trustTitle: '为可持续决策而建设', trust: [{ value: '79', label: '项目档案中的公开记录' }, { value: '4', label: '协同工作的服务领域' }, { value: '全泰国', label: '现场团队服务能力' }] },
    about: { eyebrow: '关于暹罗地下水', title: '关于我们', intro: '暹罗地下水有限公司成立于1987年，由曾在政府部门从事地下水工作的专家共同创办，专长涵盖钻井、勘查、维护与地下水利用。', storyTitle: '公司历程', story: ['公司成立的宗旨，是依照专业技术原则钻井并开发利用地下水，推动节约和保护地下水资源，使其能够持续使用，并提高资源利用效益，造福地下水使用者和泰国全国民众。', '凭借长期经验与项目成果，我们持续提升质量和效率，并将现代技术与知识应用于工作。目前可提供地下水勘查研究、优质地下水井施工，以及符合实际含水层条件和用水需求的水资源管理方案。'], principlesTitle: '工作原则', principles: [{ title: '钻井前先掌握资料', description: '以场地限制和水文地质资料作为勘查与设计的基础。' }, { title: '保护含水层', description: '通过合理规划井体结构和抽水量，减少可以避免的损害。' }, { title: '结果可衡量', description: '抽水试验、水质结果和运行记录让水井成为可管理的资产。' }, { title: '维护长期使用', description: '基线资料和适当维护有助于保持水量、水质和能源效率。' }], teamTitle: '暹罗地下水团队', teamIntro: '经验丰富的勘查团队使用电阻率仪进行调查和解释；钻井团队接受培训并持有泰国地下水资源厅颁发的钻井许可证；维护团队则专长于水井、水泵和抽水试验。' },
    services: { eyebrow: '地下水服务', title: '我们的服务', intro: '可选择专业单项服务，也可由我们统筹完整的地下水系统工作。', highlightsTitle: '服务范围', processTitle: '一般工作流程', items: {
      survey: { title: '地下水、矿泉水、温泉及EIA调查', short: '由专家和技术熟练、经验丰富的勘查团队执行。', intro: '为计划钻井并使用地下水的项目提供研究与勘查，采用电阻率调查方法，同时涵盖矿泉、温泉资源勘查以及环境影响评价（EIA）报告所需的调查工作。', highlights: ['资料审查与现场踏勘', '水文地质及地球物理调查', '候选井位评估', '项目与EIA协调报告'], process: ['明确用水需求和决策标准', '审查既有资料与场地风险', '实施现场调查', '排序井位并提出下一步建议'] },
      drilling: { title: '地下水井、矿泉井、温泉井及降水井', short: '依照专业技术原则钻井和安装水泵，并妥善封填停用的地下水井。', intro: '依照技术标准和《地下水法》施工地下水井，包括砂砾含水层井、硬岩井、降水井和观测井。', highlights: ['生产与供水井', '矿泉与温泉井', '基坑降水系统', '洗井、抽水试验与成井记录'], process: ['确认调查结果和施工通道', '制定结构与验收标准', '钻进、编录并成井', '洗井、试验并完成资料'] },
      maintenance: { title: '地下水井与水泵维护', short: '正确维护有助于延长地下水井和水泵的使用寿命。', intro: '长期运行的水井可能被泥砂、铁锈或水垢堵塞，导致进水量下降。应每年进行气举清洗、洗井和水泵检查，或根据实际运行条件安排合适周期。', highlights: ['气举洗井与井内清洗', '水泵拆装、检查和维修', '水泵安装深度与控制调整', '流量、水位和能耗趋势分析'], process: ['收集基线与故障现象', '检查水井和抽水系统', '选择有效且损伤最小的处理方式', '复测并设定监测阈值'] },
      consult: { title: '修复出现问题或损坏的地下水项目', short: '修复大型水井通常比重新钻井更具经济性。', intro: '我们采用专门方法修复受损的8–12英寸大型水井，包括出砂、水浑浊、井体堵塞、咸水侵入、井管渗漏、污水进入或水泵故障。与重新钻井相比，修复可能更快、成本更低，并能保留原有投资价值。', highlights: ['低流量和降深分析', '出砂、浑浊及井体完整性诊断', '盐分、酸性和污染通道分析', '修复方案与业主技术支持'], process: ['审查原始资料和故障历史', '测量当前水力与水质状态', '验证最可能的原因', '排序修复、更换或运行调整方案'] },
    } },
    projects: { eyebrow: '项目档案', title: '我们的项目案例', intro: '我们在地下水勘查研究、优质地下水井施工，以及符合含水层条件的地下水管理规划方面拥有丰富经验，帮助项目持续获得充足的优质用水。', all: '全部项目', showing: '当前显示', loadMore: '显示更多项目', details: '查看项目', typeLabel: '项目类型', categoryLabel: '行业', location: '项目地点', yearLabel: '项目年份', workScopeLabel: '工作范围', businessTypeLabel: '业务领域', projectStoryTitle: '工作详情', recoveredRecordNote: '根据公司旧网站公开的项目档案和内容整理。项目正文目前使用英文翻译。', registryNoteTitle: '关于本记录', registryNote: '本记录整理自公司旧网站曾公开的项目信息；合同细节和客户敏感信息仍予保密。如需类似案例，请联系我们的团队。', mapCta: '在Google地图中打开', enquiryCta: '咨询类似项目经验', categories: { government: '政府', factory: '工厂', resort: '酒店与度假村', agriculture: '农业与畜牧', dewatering: '降水工程', other: '其他' }, types: { agriculture: '农业地下水项目', factory: '工业地下水项目', government: '政府地下水项目', 'island, resort': '海岛度假村地下水项目', infrastructure: '降水与基础设施项目', other: '地下水项目', resort: '酒店与度假村地下水项目', train: '基础设施地下水项目' } },
    governance: { eyebrow: '地下水保护项目', title: '明智使用地下水，保护国家水源', intro: '地下水弥足珍贵，应以保护为原则进行开发。“地下水保护项目”成立于2000年12月22日，旨在推动明智用水，并保护地下水资源，使其能够持续利用。', pillars: [{ title: '技术诚信', description: '建议基于现有资料、明确假设和可衡量的验收标准。' }, { title: '环境责任', description: '采用可持续抽水量和保护地下水层的成井方式。' }, { title: '安全与现场纪律', description: '通过计划、现场控制和合适设备支持安全施工。' }, { title: '尊重客户信息', description: '敏感项目资料仅用于项目交付，未经许可不公开。' }], commitmentTitle: '地下水保护承诺', commitment: '“明智使用地下水，保护国家水源。地下水弥足珍贵，应以保护为原则进行开发。”' },
  ...
  ja: {
    ...
    home: { eyebrow: '地下水保全', title: '高品質な井戸を掘り、高品質なポンプを設置し、地下水を正しく汲み上げて利用する', summary: '高品質な地下水井の掘削と、技術原則に沿った地下水の開発利用におけるリーダーを目指します。', assurance: '帯水層を傷めず、環境を壊さないよう予防し、すべてのプロジェクトで良質な水を持続的に利用でき、投資に見合うよう維持管理します。', motto: '善い行いで大地に恩返しする', primaryCta: 'プロジェクトを相談', secondaryCta: 'サービスを見る', servicesTitle: '一つの技術チームが井戸の全使用期間を支援', servicesIntro: '調査、掘削、ポンプ設置、水質確認、長期保守を連携させることで、設計間の抜けを減らします。', projectsTitle: '全国すべての地域での実績', projectsIntro: 'タイ国内および周辺地域の行政、工業、ホテル、農業、インフラ分野での実績です。', trustTitle: '持続可能な判断のための実績', trust: [{ value: '79', label: '実績台帳で公開している案件' }, { value: '4', label: '連携するサービス分野' }, { value: 'タイ全土', label: '現場チームの対応力' }] },
    about: { eyebrow: 'サイアム・グラウンドウォーターについて', title: '会社案内', intro: 'サイアム・グラウンドウォーター株式会社は、政府機関で地下水業務に携わった専門家により1987年に設立されました。掘削、調査、保守、地下水利用を専門としています。', storyTitle: '沿革', story: ['当社は、技術原則に沿って地下水を掘削・開発利用し、地下水の保全利用を促進し、持続的に利用できるよう地下水資源を守り、地下水利用者とタイ全国の人々のために資源を有効活用することを目的として設立されました。', 'これまでの経験と実績をもとに、最新の技術と知見を業務へ取り入れながら、品質と効率を継続的に向上させてきました。現在は地下水調査、高品質な地下水井の掘削、実際の帯水層条件と用途に合った水管理の開発を提供しています。'], principlesTitle: '仕事の原則', principles: [{ title: '掘削前の情報', description: '敷地条件と水文地質情報を調査・設計の基礎にします。' }, { title: '帯水層を守る', description: '予防可能な損傷を減らすため、井戸構造と揚水量を計画します。' }, { title: '結果を測定する', description: '揚水試験、水質、運転記録により井戸を管理可能な資産にします。' }, { title: '長く使えるよう維持する', description: '基準データと適切な保守で水量、水質、エネルギー効率を守ります。' }], teamTitle: 'サイアム・グラウンドウォーターチーム', teamIntro: '経験豊富な調査チームが比抵抗計を用いて調査・解析を行います。掘削チームは研修を受け、タイ地下水資源局の掘削許可を保有し、保守チームは井戸、ポンプ、揚水試験を専門としています。' },
    services: { eyebrow: '地下水サービス', title: 'サービス一覧', intro: '専門サービスを個別に選ぶことも、地下水システム全体の調整を任せることもできます。', highlightsTitle: 'サービス範囲', processTitle: '一般的な作業手順', items: {
      survey: { title: '地下水・鉱泉・温泉・EIA調査', short: '専門家と高い技能・経験を持つ調査チームが実施します。', intro: '地下水を利用するために井戸掘削を計画するプロジェクトを対象に、電気比抵抗調査を用いた地下水調査を行います。鉱泉・温泉の調査、環境影響評価（EIA）報告に必要な調査にも対応します。', highlights: ['資料調査と現地踏査', '水文地質・物理探査', '掘削候補地点の評価', '事業・EIA調整用の報告'], process: ['水需要と判断基準を整理', '既存資料と敷地リスクを確認', '現地調査を実施', '掘削候補と次の手順を提示'] },
      drilling: { title: '地下水井・鉱泉井・温泉井・ディウォータリング井', short: '技術原則に沿った掘削とポンプ設置、廃止井の適切な埋戻しを行います。', intro: '地下水法と技術基準に沿って、砂礫層井、硬岩井、ディウォータリング井、観測井を施工します。', highlights: ['給水・生産井', '鉱泉・温泉井', 'ディウォータリングシステム', '井戸開発、揚水試験、完成記録'], process: ['調査結果と施工アクセスを確認', '構造・検収基準を設定', '掘削・検層・井戸施工', '井戸開発・試験・記録'] },
      maintenance: { title: '地下水井・ポンプの保守', short: '適切な保守により、地下水井とポンプを長く使用できます。', intro: '長期間使用した井戸は、土砂、鉄さび、スケールで目詰まりし、流入量が低下することがあります。毎年、または実際の運転状態に適した周期で、エアリフト洗浄・再生とポンプ点検を行うことが望まれます。', highlights: ['エアリフトによる井戸洗浄', 'ポンプ引上げ・点検・修理', '設置深度と制御の調整', '流量・水位・電力傾向の確認'], process: ['基準値と症状を収集', '井戸と揚水設備を点検', '効果的で損傷の少ない処置を選択', '再試験と監視基準の設定'] },
      consult: { title: '問題や損傷のある地下水プロジェクトの修復', short: '大型井戸の修復は、新設より経済的な場合があります。', intro: '砂の流入、濁り、目詰まり、塩水侵入、ケーシング漏れ、汚染水侵入、ポンプ故障がある8～12インチの大型井戸を、専門的な方法で修復します。新しい井戸を掘るより短期間・低コストで、既存投資の価値を守れる場合があります。', highlights: ['流量低下・水位低下の調査', '砂・濁り・井戸健全性の診断', '塩分・酸性・汚染経路の確認', '復旧計画と事業主側技術支援'], process: ['元資料と故障履歴を確認', '水理・水質の現状を測定', '可能性の高い原因を検証', '修理・更新・運転変更を優先順位化'] },
    } },
    projects: { eyebrow: '実績台帳', title: '当社プロジェクトの一例', intro: '地下水調査、高品質な地下水井の掘削、帯水層条件に合った地下水管理計画の実績を重ね、各プロジェクトが良質な水を十分かつ持続的に利用できるよう支援しています。', all: 'すべて', showing: '表示中', loadMore: 'さらに表示', details: '詳細を見る', typeLabel: '案件種別', categoryLabel: '分野', location: 'プロジェクト所在地', yearLabel: '実施年', workScopeLabel: '業務範囲', businessTypeLabel: '事業分野', projectStoryTitle: '作業内容', recoveredRecordNote: '会社の旧ウェブサイトで公開された実績台帳とコンテンツをもとに編集しています。案件本文は現在、英語訳で表示されます。', registryNoteTitle: 'この記録について', registryNote: '会社の旧ウェブサイトで公開されていた案件情報をもとに編集し、契約内容と顧客の機密情報は非公開としています。類似事例については当社チームへお問い合わせください。', mapCta: 'Googleマップで開く', enquiryCta: '類似実績を問い合わせる', categories: { government: '行政', factory: '工場', resort: 'ホテル・リゾート', agriculture: '農業・畜産', dewatering: 'ディウォータリング', other: 'その他' }, types: { agriculture: '農業地下水プロジェクト', factory: '工業地下水プロジェクト', government: '行政地下水プロジェクト', 'island, resort': '島嶼リゾート地下水プロジェクト', infrastructure: 'ディウォータリング・インフラプロジェクト', other: '地下水プロジェクト', resort: 'ホテル・リゾート地下水プロジェクト', train: 'インフラ地下水プロジェクト' } },
    governance: { eyebrow: '地下水保全プロジェクト', title: '賢く利用し、国の水源を守る', intro: '地下水は貴重であり、保全を重視して開発すべき資源です。地下水保全プロジェクトは、賢明な利用を促進し、地下水源を持続的に使えるよう守るため、2000年12月22日に設立されました。', pillars: [{ title: '技術的誠実さ', description: '入手可能な根拠、明示した仮定、測定可能な検収基準に基づいて提案します。' }, { title: '環境への責任', description: '持続可能な揚水量と地下水層を守る施工を目指します。' }, { title: '安全と現場規律', description: '計画、現場管理、適切な機材で安全な施工・保守を支えます。' }, { title: '顧客情報の尊重', description: '機密情報は業務遂行にのみ使用し、適切な許可なく公開しません。' }], commitmentTitle: '地下水保全への約束', commitment: '「地下水を賢く利用し、国の水源を傷めない。地下水は貴重であり、保全を重視して開発する。」' },
